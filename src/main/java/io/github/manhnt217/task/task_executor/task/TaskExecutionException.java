...
public class TaskExecutionException extends Exception {
    ...
    public TaskExecutionException(String taskName, JsonNode input, String message, Throwable e) {
    ...
    public TaskExecutionException(String taskName, JsonNode input, Throwable e) {
